			...
			if($state == ""){ //new email
				...
				if(ajaxNewsletter::sendConfEmail($email, $confKey)){
					...
					if(ajaxNewsletter::addMember($email, $confKey)){
						...
						$returnVal['message']="A confirmação foi enviado para seu e-mail.";
						return $returnVal;
					}
				}
				
				$returnVal['result']=false;
				$returnVal['message']="Ocorreu um erro. Por favor, tente novamente mais tarde.";
				return $returnVal;
				...
				if(ajaxNewsletter::resendConfEmail($email)){
					$returnVal['result']=true;
					$returnVal['message']="A confirmação foi reenviada para seu e-mail.";
				}else{
					$returnVal['result']=false;
					$returnVal['message']="Ocorreu um erro. Por favor, tente novamente mais tarde.";
				}

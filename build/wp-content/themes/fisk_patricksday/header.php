...
<title><?php
	...
	if ( $paged >= 2 || $page >= 2 )
		echo ' | ' . sprintf( __( 'Page %s', 'fiskpatricksday' ), max( $paged, $page ) );
		...
		<!--<div id="masthead">-->
			...
			<div id="access" role="navigation">
			  <?php /*  Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff */ ?>
				<!--<div class="skip-link screen-reader-text"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'fiskpatricksday' ); ?>"><?php _e( 'Skip to content', 'fiskpatricksday' ); ?></a></div>-->

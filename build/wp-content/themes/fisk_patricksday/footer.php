    	...
    	<div class="construtor">
            ...
            <div id="colophon">
                ...
                <div id="site-generator">
                    <?php do_action( 'fiskpatricksday_credits' ); ?>
                    <a href="<?php echo esc_url( __( 'http://wordpress.org/', 'fiskpatricksday' ) ); ?>" title="<?php esc_attr_e( 'Semantic Personal Publishing Platform', 'fiskpatricksday' ); ?>" rel="generator"><?php printf( __( 'Proudly powered by %s.', 'fiskpatricksday' ), 'WordPress' ); ?></a>
                </div><!-- #site-generator -->

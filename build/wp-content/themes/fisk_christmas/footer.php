    	...
    	<div class="construtor">
            ...
            <div id="colophon">
                ...
                <div id="site-generator">
                    <?php do_action( 'fiskchristmas_credits' ); ?>
                    <a href="<?php echo esc_url( __( 'http://wordpress.org/', 'fiskchristmas' ) ); ?>" title="<?php esc_attr_e( 'Semantic Personal Publishing Platform', 'fiskchristmas' ); ?>" rel="generator"><?php printf( __( 'Proudly powered by %s.', 'fiskchristmas' ), 'WordPress' ); ?></a>
                </div><!-- #site-generator -->

    	...
    	<div class="construtor">
            ...
            <div id="colophon">
                ...
                <div id="site-generator">
                    <?php do_action( 'fiskhalloween_credits' ); ?>
                    <a href="<?php echo esc_url( __( 'http://wordpress.org/', 'fiskhalloween' ) ); ?>" title="<?php esc_attr_e( 'Semantic Personal Publishing Platform', 'fiskhalloween' ); ?>" rel="generator"><?php printf( __( 'Proudly powered by %s.', 'fiskhalloween' ), 'WordPress' ); ?></a>
                </div><!-- #site-generator -->

...
<title><?php
	...
	if ( $paged >= 2 || $page >= 2 )
		echo ' | ' . sprintf( __( 'Page %s', 'fiskhalloween' ), max( $paged, $page ) );
...
<!--<a href="<?php get_page_link( "25" ) ?>" title="Faça um Test Drive" id="bt_badge">Faça um Test Drive</a>-->
		...
		<!--<div id="masthead">-->
			...
			<div id="access" role="navigation">
			  <?php /*  Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff */ ?>
				<!--<div class="skip-link screen-reader-text"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'fiskhalloween' ); ?>"><?php _e( 'Skip to content', 'fiskhalloween' ); ?></a></div>-->

...
<div id="conteudo_pagina">
    ...
    <?php $cat = single_cat_title( '', false ); 
		...
		{
	?>
    <h3 class="page-title"><?php printf( __( 'Category Archives: %s', 'fiskthanksgiving' ), '<span>' . $cat . '</span>' ); ?> </h3>
   	<?php 
		}
	?>
...
<?php if ( ! have_posts() ) : ?>
	<div id="post-0" class="post error404 not-found">
		<h1 class="entry-title"><?php _e( 'Not Found', 'fiskthanksgiving' ); ?></h1>
		<div class="entry-content">
			<p><?php _e( 'Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.', 'fiskthanksgiving' ); ?></p>
			<?php get_search_form(); ?>
		</div><!-- .entry-content -->
	</div><!-- #post-0 -->
<?php endif; ?>
...
<?php /* How to display posts of the Gallery format. The gallery category is the old way. */ ?>
	<?php if ( ( function_exists( 'get_post_format' ) && 'gallery' == get_post_format( $post->ID ) ) || in_category( _x( 'gallery', 'gallery category slug', 'fiskthanksgiving' ) ) ) : ?>
    	<!--<p>Mateus 1</p>-->
...
<?php else : ?>
				...
				?>
						...
						<p><em><?php printf( _n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, 'fiskthanksgiving' ),
								'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'fiskthanksgiving' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
...
<?php endif; ?>
			...
			<?php if ( function_exists( 'get_post_format' ) && 'gallery' == get_post_format( $post->ID ) ) : ?>
				<a href="<?php echo get_post_format_link( 'gallery' ); ?>" title="<?php esc_attr_e( 'View Galleries', 'fiskthanksgiving' ); ?>"><?php _e( 'More Galleries', 'fiskthanksgiving' ); ?></a>
				<span class="meta-sep">|</span>
			<?php elseif ( in_category( _x( 'gallery', 'gallery category slug', 'fiskthanksgiving' ) ) ) : ?>
				<a href="<?php echo get_term_link( _x( 'gallery', 'gallery category slug', 'fiskthanksgiving' ), 'category' ); ?>" title="<?php esc_attr_e( 'View posts in the Gallery category', 'fiskthanksgiving' ); ?>"><?php _e( 'More Galleries', 'fiskthanksgiving' ); ?></a>
				<span class="meta-sep">|</span>
			<?php endif; ?>
...
<?php /* How to display posts of the Aside format. The asides category is the old way. */ ?>
	...
	<?php elseif ( ( function_exists( 'get_post_format' ) && 'aside' == get_post_format( $post->ID ) ) || in_category( _x( 'asides', 'asides category slug', 'fiskthanksgiving' ) )  ) : ?>
    	<!--<p>Mateus 2</p>-->
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php else : ?>
			<div class="entry-content">
				<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'fiskthanksgiving' ) ); ?>
			</div><!-- .entry-content -->
		<?php endif; ?>

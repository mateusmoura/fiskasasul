    	...
    	<div class="construtor">
            ...
            <div id="colophon">
                ...
                <div id="site-generator">
                    <?php do_action( 'fiskthanksgiving_credits' ); ?>
                    <a href="<?php echo esc_url( __( 'http://wordpress.org/', 'fiskthanksgiving' ) ); ?>" title="<?php esc_attr_e( 'Semantic Personal Publishing Platform', 'fiskthanksgiving' ); ?>" rel="generator"><?php printf( __( 'Proudly powered by %s.', 'fiskthanksgiving' ), 'WordPress' ); ?></a>
                </div><!-- #site-generator -->

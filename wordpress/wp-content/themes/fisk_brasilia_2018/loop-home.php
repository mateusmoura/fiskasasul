...
<div id="conteudo_pagina_home">
	...
	<div id="bloco_home">
		...
		<ul id="imagens_asasul">
			<li class="primeira-img"><a href="<?php echo get_page_link( "19" ); ?>"><img alt="Asa Sul" src="<?php bloginfo( 'template_url' ); ?>/images/unidades/asasul_1.2.jpg"></a></li>
			<li class="segunda-img"><a href="<?php echo get_page_link( "19" ); ?>"><img alt="Asa Sul" src="<?php bloginfo( 'template_url' ); ?>/images/unidades/asasul_2.2.jpg"></a></li>
			<li class="terceira-img"><a href="<?php echo get_page_link( "19" ); ?>"><img alt="Asa Sul" src="<?php bloginfo( 'template_url' ); ?>/images/unidades/asasul_3.2.jpg"></a></li>
		</ul>
		<?php /*?><?php echo do_shortcode("[nggallery id=1 images=3]"); ?><?php */?>
		<h2 id="titulo_tagnorte">FISK Taguatinga Norte</h2>
		<ul id="imagens_tagua">
			<li class="primeira-img"><a href="<?php echo get_page_link( "21" ); ?>"><img alt="Taguatinga Norte" src="<?php bloginfo( 'template_url' ); ?>/images/unidades/tagua_1.jpg" width="100" height="67"></a></li>
			<li class="segunda-img"><a href="<?php echo get_page_link( "21" ); ?>"><img alt="Taguatinga Norte" src="<?php bloginfo( 'template_url' ); ?>/images/unidades/tagua_2.jpg" width="100" height="67"></a></li>
			<li class="terceira-img"><a href="<?php echo get_page_link( "21" ); ?>"><img alt="Taguatinga Norte" src="<?php bloginfo( 'template_url' ); ?>/images/unidades/tagua_3.jpg" width="100" height="67"></a></li>
		</ul>
		<?php /*?><?php echo do_shortcode("[nggallery id=3 images=3]"); ?><?php */?>
		<h2 id="titulo_asanorte">FISK Asa Norte</h2>
		<ul id="imagens_tagua">
			<li class="primeira-img"><a href="<?php echo get_page_link( "1013" ); ?>"><img alt="Asa Norte" src="<?php bloginfo( 'template_url' ); ?>/images/unidades/asanorte.JPG" width="100" height="67"></a></li>
			<li class="segunda-img"><a href="<?php echo get_page_link( "1013" ); ?>"><img alt="Asa Norte" src="<?php bloginfo( 'template_url' ); ?>/images/unidades/asanorte2.JPG" width="100" height="67"></a></li>
			<li class="terceira-img"><a href="<?php echo get_page_link( "1013" ); ?>"><img alt="Asa Norte" src="<?php bloginfo( 'template_url' ); ?>/images/unidades/asanorte3.JPG" width="100" height="67"></a></li>
		</ul>

					...
					<!--<div class="entry-content">-->
						...
						<?php if( $idP == 17 )
							...
							<div id="quadro_cursos">
								...
								<div class="bloco_curso" id="bloco_frances">
									<img src="http://www.fiskasasul.com.br/wp-content/themes/fisk_brasilia_2013/images/badges/frances.png" alt="" title="Francês" width="80" height="90" class="alignleft size-full wp-image-264" />
									<h2>Francês</h2>
									<p>Parlez Français! Agora na FISK você pode também aprender Francês! Conheça o curso de Francês para jovens e adultos.</p>
									<p><a href="<?php echo get_page_link( "1070" ) ?>">Veja o curso de Francês</a></p>
								</div>
